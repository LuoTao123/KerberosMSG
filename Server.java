...
public ServerThread(){
	...
	while(client.socket.isConnected()){
		...
		try{
		 if((aline=client.dis.readLine())!=null)
				{ 
					if(aline.equals("exit"))
					{ 
						message.append("客户："+client.getAccount()+"已退出!\n");
						userName.removeElement(client.getAccount()); 
							break;
						 }
					message.append(client.getAccount()+"说："+aline+"\n");
				}
...
class User{
		...
		public void setSocket(Socket socket,BufferedReader dis,PrintWriter dos)
		{this.socket=socket;
		this.dos=dos;
		this.dis=dis;
		}
